# This script parses through the ACM website and scrapes the author affiliations and titles for the IJCAI conference
...
year = '2018'
num_heading = '2'
IJCAI_url = 'https://dl.acm.org/doi/proceedings/10.5555/3304889?tocHeading=heading2'
#########################################################################################h
...
df.to_csv(path+year+'_'+num_heading+'_output_AAAI.csv')
