# This script parses through the folders given in the list 'folders' and goes into each XML file in each folder and extracts the respective data then exports into a CSV file.
